...
export class PostComponent implements OnInit {
  ...
  listOfStudents:Array<string> = ["dennis","josh","hassan","mariam","souvik","chita","elixabeth"]

  listOfStudentPost:Array<any> =[
    {id:1, name:"dennis", postTitle:"How to cook food"},
    {id:2, name:"mariam", postTitle:"How to eat"},
    {id:3, name:"souvik", postTitle:"How to keep fit"},
    {id:4, name:"jane", postTitle:"How to train Dog"},
  ]
